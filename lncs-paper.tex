...
Several works show how to define the Zipper~\cite{Huet1997} generically for regular~\cite{HiJeLo2004,McBride2001}, mutually recursive~\cite{MuRec2009}, and heterogeneous~\cite{Adams2010} types using fixed-point generic views.
