...
We implement the \texttt{In} constraint by means of a type family \texttt{InFam} exactly along the lines of \texttt{Equal} family defined in the beginning of Section~\ref{sec:handling-recursion}. 
